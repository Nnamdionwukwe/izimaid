...
const steps = [
  ...
  "The team came to do a deep cleaning at my house this week and they did an amazing job. We were beyond grateful since my husband and I work and study at the same time we have little to no time for cleaning the house and Molly Maid's team made our house look incredible. We are beyond happy and grateful with the team and their service.",
  "Wow I am so impressed with Team #8 Araceli and Cristina! This is the first time I have had my home professionally cleaned and I can definitely say I will not hesitate to book with Molly Maid again. My home has never been cleaner and fresher. I would recommend Molly Maid to my friends and family in a heartbeat.",
  "Our cleaning team arrived promptly and started cleaning immediately. They were very friendly and took great care to ensure they did a good job. Im very impressed with the company so far! From the initial in-home estimate to the first cleaning! Even having a supervisor stop by to ensure the cleaning was done properly. I look forward to continue to work with the company.",
  "I have been using Molly Maid for a few months now and I am very happy with the service. The team is always on time, professional, and does a great job cleaning my home. I appreciate the attention to detail and the personalized service they provide. I highly recommend Molly Maid to anyone looking for a reliable and thorough cleaning service.",
];

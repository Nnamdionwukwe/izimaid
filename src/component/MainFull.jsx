  ...
  return (
    <div className={styles.mainDivMain}>
      ...
      <div className={styles.mainDiv}>
        <div className={styles.mainDivSub}>
          <div>
            ...
            <div>
              ...
              <div className={styles.nameFlex}>
                <div>
                  <div>
                    ...
                    {isOpen1 && (
                      <p className={styles.error}>Enter the first name</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {isOpen2 && (
                      <p className={styles.error}>Enter the last name</p>
                    )}
                  </div>
                </div>

                <div className={styles.nameFlexSub}>
                  <div>
                    <div className={styles.name}>
                      <h4>Email*</h4>
                    </div>
                  ...
                  <div>
                    ...
                    {isOpen4 && (
                      <p className={styles.error}>Enter the phone number</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className={styles.privacy}>
                <p>
                  By checking this box, I agree to opt in to receive automated
                  SMS and/or MMS messages from IziMaid, an IziBest company, and
                  its franchisees to the provided mobile number(s). Message &
                  data rates may apply. Message frequency varies. View{" "}
                  <span className={styles.span}>Terms</span> and{" "}
                  <span className={styles.span}> Privacy Policy</span>. Reply
                  STOP to opt out of future messages. Reply HELP for help.
                </p>
              </div>
              ...
              <div>
                ...
                {isOpen5 && (
                  <p className={styles.error}>Enter a valid ZIP code</p>
                )}
              </div>
              ...
              <div className={styles.addressFull}>
                ...
                <div className={styles.addressFullDivSub}>
                  <div className={styles.name}>
                    ...
                    <div className={styles.typeOfCleaning}>
                      ...
                      <div className={styles.radioButton}>
                        <p
                          ...
                          className={
                            oneTimeClean ? styles.radio2 : styles.radio
                          }
                        ></p>
